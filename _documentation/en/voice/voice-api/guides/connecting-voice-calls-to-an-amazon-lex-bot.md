...
![A diagram that outlines how Amazon Lex and the Vonage Voice API work together to create a voice bot](/images/voice-api/amazon-lex-bot/lex.png "A diagram that outlines how Amazon Lex and the Vonage Voice API work together to create a voice bot")
...
![Start developing in minutes with free credits on us. No credit card required!](/images/voice-api/amazon-lex-bot/sign_up_banner.png)
...
![The Amazon Lex service dashboard](/images/voice-api/amazon-lex-bot/screen-01.png "The Amazon Lex service dashboard")
...
![The Amazon Lex Bot Creation Dashboard](/images/voice-api/amazon-lex-bot/screen-02.png "The Amazon Lex Bot Creation Dashboard")
...
![The Lex bot setup screen from Amazon Web Services](/images/voice-api/amazon-lex-bot/screen-03a.png "The Lex bot setup screen from Amazon Web Services")
...
![Final steps in the bot setup process](/images/voice-api/amazon-lex-bot/screen-03b.png "Final steps in the bot setup process")

When the bot creation process has completed, you will see a screen similar to the one shown below.

![The bot has been created successfully](/images/voice-api/amazon-lex-bot/screen-04.png "The bot has been created successfully")
...
![Adding an alias name to your Amazon Lex Bot](/images/voice-api/amazon-lex-bot/screen-05b.png "Adding an alias name to your Amazon Lex Bot")

Clicking **Publish** once more will finalize the setup of your sample bot.

![Notification that the bot has been published](/images/voice-api/amazon-lex-bot/screen-05c.png "Notification that the bot has been published")
...
![The Lex Dashboard](/images/voice-api/amazon-lex-bot/screen-1-a.png "The Lex Dashboard")

Next, click on **Create Intent**.

![Creating an intent for a Lex bot](/images/voice-api/amazon-lex-bot/screen-1-b.png "Creating an intent for a Lex bot")
...
![Entering a name for the intent](/images/voice-api/amazon-lex-bot/screen-1-c.png "Entering a name for the intent")
...
![Adding new utterances to a Lex bot](/images/voice-api/amazon-lex-bot/screen-1-d.png "Adding new utterances to a Lex bot")

Next, under **Response** click on **Add Message**.

![Adding a new message to the bot responder](/images/voice-api/amazon-lex-bot/screen-1-f.png "Adding a new message to the bot responder")
...
![Adding a message response to a Lex bot](/images/voice-api/amazon-lex-bot/screen-1-g.png "Adding a message response to a Lex bot")

After adding all desired messages, click on **Save Intent**.

![Listing message responses](/images/voice-api/amazon-lex-bot/screen-1-h.png "Listing message responses")
...
![Entering 'staging' as the alias for the Lex bot](/images/voice-api/amazon-lex-bot/screen-1-n.png "Entering 'staging' as the alias for the Lex bot")
...
![Editing the Lex bot](/images/voice-api/amazon-lex-bot/screen-2-a.png "Editing the Lex bot")

Under **Response**, click on **Add Message**.

![Adding a new message to the Lex bot](/images/voice-api/amazon-lex-bot/screen-2-b.png "Adding a new message to the Lex bot")
...
![Adding a new message to the Lex bot](/images/voice-api/amazon-lex-bot/screen-2-c.png "Adding a new message to the Lex bot")
...
![A successfully published bot](/images/voice-api/amazon-lex-bot/screen-2-i.png "A successfully published bot")
