...
This guide is based on the [IVR](https://www.nexmo.com/use-cases/interactive-voice-response/) use case. All the code is available on [GitHub](https://github.com/Nexmo/php-phone-menu).
