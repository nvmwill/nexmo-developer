...
| 16         | Gateway Quota Exceeded    |Message delivery failed because the allowed number of requests per minute was exceeded. **NB:** This error is shown for accounts registered in the US and France only.                                    |
